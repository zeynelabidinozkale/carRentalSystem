...
<section class="mt-5 mb-100">
    <div class="container mb-5">
        @switch($request->step)
            ...
            @break
            @case('vehicle')
            <form id="vehicleFilterForm" class="row" action="">
                <div class="col-md-4">
                                ...
                                <tbody >
                                    <tr class="bt-0 text-center">
                                        <td class="p-0 border w-50">
                                            <span class="btn btn-block btn-light">asdf{{-- {{ $vehicle->pivot->cost }} --}}</span>
                                        </td>
                                        <td class="p-0 border w-50">
                                            <button class="btn btn-block btn-success">Choose Vehicle</button>
                                        </td>
                                    </tr>
                                </tbody>
                            </table>
